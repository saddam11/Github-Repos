...
{
    public class UserService//:TblUserDAL
    {
        ...
        public TblUser ValidateUser(TblUser objTblUser )
        {
            try
            {
                ...
                cmd.CommandText = "Select * from tbl_User where UserName='" + objTblUser.UserName + "' and UserPwd='"+ objTblUser.UserPwd +"'";
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    objTblUser.UserPwd = ds.Tables[0].Rows[i][4].ToString();
                }
                return objTblUser;
            }
            catch (Exception)
